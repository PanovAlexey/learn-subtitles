...
func (s *ReadyToAddSubtitlesNameState) AddForbiddenPartsAndSaveSubtitles(
...
func (s *ReadyToAddSubtitlesNameState) GetRandomPhraseByCurrentSubtitles() (entity.Phrase, error) {
